...
Thanks for your interest in ReactQuery-to-Redux! You are very welcome to contribute.

By contributing to ReactQuery-to-Redux, you agree to abide by the [code of conduct](./CODE_OF_CONDUCT.md).

## Reporting Bugs and Asking Questions

Before opening an issue, please search the [issue tracker](https://github.com/spautz/reactquery-to-redux/issues)
to make sure your issue hasn't already been reported.

### New Features and Ideas

If you are proposing a new feature, make sure to [open an issue](https://github.com/spautz/reactquery-to-redux/issues/new/choose)
...
1. Fork this repository to your own GitHub account and clone it to your local device:
   ...
   ```
   git clone https://github.com/your-name/reactquery-to-redux.git
   cd reactquery-to-redux
   git remote add upstream https://github.com/spautz/reactquery-to-redux.git
   ```
...
4. To test your local dev version of `reactquery-to-redux` in other projects, [Yalc](https://github.com/whitecolor/yalc)
...
1. Open a new issue in the [Issue tracker](https://github.com/spautz/reactquery-to-redux/issues).
...
5. Submit a [pull request](https://github.com/spautz/reactquery-to-redux/pulls), referencing any issues it addresses.
